...
public static class Tables
{
    ...
    public static readonly stColor[][][] colorRows = new stColor[4][][]
    {
        ...
        new stColor[4][]
        {
            ...
            new stColor[12] { stColor.green, stColor.yellow, stColor.yellow, stColor.pink, stColor.green, stColor.pink, stColor.green, stColor.blue, stColor.green, stColor.blue, stColor.pink, stColor.blue },
